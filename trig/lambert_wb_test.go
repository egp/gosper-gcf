...
func TestWB_LambertKernel_Root_CircularOneHalfMatchesKnownPrefix(t *testing.T) {
	k := newLambertKernel(
		lambertModeCircular,
		core.PQStreamFromRational(core.NewRational(big.NewInt(1), big.NewInt(2))),
	)
...
func TestWB_LambertKernel_Root_HyperbolicOneHalfMatchesKnownPrefix(t *testing.T) {
	k := newLambertKernel(
		lambertModeHyperbolic,
		core.PQStreamFromRational(core.NewRational(big.NewInt(1), big.NewInt(2))),
	)
...
func TestWB_LambertKernel_Root_HyperbolicOneMatchesKnownPrefix(t *testing.T) {
	k := newLambertKernel(
		lambertModeHyperbolic,
		core.PQStreamFromRational(core.RationalFromInt64(1)),
	)
